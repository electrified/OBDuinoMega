...
void gpsdump(TinyGPS &gps)
{
  ...
  HOST.print("Alt(cm): "); HOST.print(gps.altitude(), 2);
  HOST.print(" Course(10^-2 deg): "); HOST.print(gps.course(), 2);
  HOST.print(" Speed(10^-2 knots): "); HOST.print(gps.speed(), 2);
  HOST.println();
  HOST.print("Alt(float): "); printFloat(gps.f_altitude(), 2);
  HOST.print(" Course(float): "); printFloat(gps.f_course(), 2);
  HOST.println();
  HOST.print("Speed(knots): "); printFloat(gps.f_speed_knots(), 2);
  HOST.print(" (mph): ");  printFloat(gps.f_speed_mph(), 2);
  HOST.print(" (mps): "); printFloat(gps.f_speed_mps(), 2);
  HOST.print(" (kmph): "); printFloat(gps.f_speed_kmph(), 2);
  HOST.println();
